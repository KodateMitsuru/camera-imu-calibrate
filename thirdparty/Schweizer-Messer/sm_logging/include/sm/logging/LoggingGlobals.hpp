...
typedef boost::interprocess::basic_vectorstream<std::vector<char> >
    vectorstream;
...
class LoggingGlobals {
 public:
  ...
  void initializeLogLocation(LogLocation* loc, const std::string& name,
                             Level level);
  ...
  void print(const char* streamName, Level level, const char* file, int line,
             const char* function, const char* fmt, ...)
      SMCONSOLE_PRINTF_ATTRIBUTE(7, 8);
  void print(const char* streamName, Level level, vectorstream& ss,
