...
class GridCalibrationTargetCheckerboard : public GridCalibrationTargetBase {
 public:
  ...
  GridCalibrationTargetCheckerboard(
      size_t rows, size_t cols, double rowSpacingMeters,
      double colSpacingMeters,
      const GridCalibrationTargetCheckerboard::CheckerboardOptions &options =
          CheckerboardOptions());
 ...
 protected:
  ...
  template <class Archive>
  void save(Archive &ar, const unsigned int /* version */) const {
    boost::serialization::void_cast_register<GridCalibrationTargetCheckerboard,
